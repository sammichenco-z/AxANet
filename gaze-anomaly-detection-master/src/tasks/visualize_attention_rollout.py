...
from src.modeling.drama_bbox_tr_with_clip_caption import \
    DRAMAVideoTransformerTRGTCAPTION
...
def main(args):
    ...
    for mode in ['test']:
        ...
        for idx in tqdm(range(len(filenames))):
            ...
            cv2.imwrite(os.path.join(save_path, image_key+"_"+str(0).zfill(3)+".jpg"), cam_image)
