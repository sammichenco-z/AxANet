...
def main(args):
    ...
    save_path = f"raw_attention_human_machine_v3_{args.human_choose}_{args.time}"
    ...
    for mode in ['test']:
        ...
        for idx in tqdm(range(len(filenames))):
            ...
            all_outputs[filename] = all_bboxs.tolist()
            ...
            # if idx > 1000:
            #     break
    with open(os.path.join(save_path, "drama_outputs.json"), "w") as f:
