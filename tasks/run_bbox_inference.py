...
def inference(args, img_key, video_data, model, gt_bbox, class_label):
    ...
    return all_bboxs, all_bbox_ious, all_classes
...
def main(args):
    ...
    for mode in ['val', 'test']:
        ...
        for idx in tqdm(range(len(filenames))):
            ...
            output = inference(args, image_key, preproc_raw_frames.unsqueeze(0), vl_transformer, gt_bbox.unsqueeze(0), class_label.unsqueeze(0))
            print(image_key, output)
