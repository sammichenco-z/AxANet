...
def get_swin_model(args):
    if int(args.img_res) == 384:
        ...
        # config_path = '../modeling/video_swin/swin_%s_patch244_window877_kinetics%s_22k.py' % (
        # args.vidswin_size, args.kinetics)
    ...
    if args.pretrained_2d:
        ...
        config_path = '../modeling/video_swin/swin_base_patch244_window877_kinetics400_22k.py'
