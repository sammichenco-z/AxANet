...
from src.modeling.video_captioning_with_point_prompt import VideoTransformerPointPrompt
# from src.modeling.multitask_e2e_vid_swin_bert import MultitaskVideoTransformer
# from src.modeling.drama_e2e_vid_swin_bert import DRAMAVideoTransformer
...
def main(args):
    ...
    vl_transformer = VideoTransformerPointPrompt(args, config, swin_model, bert_model)
