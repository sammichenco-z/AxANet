...
# from src.modeling.bddoia_classification_gaze_crossattn import DRAMAGAZEVideoTransformer_gaze
# from src.modeling.bddoia_classification_gaze_crossattn_oneblock import DRAMAGAZEVideoTransformer_gaze
# from src.modeling.bddoia_classification_gaze_crossattn_twoblock import DRAMAGAZEVideoTransformer_gaze
# from src.modeling.bddoia_classification_gaze_crossattn_twodecoder import DRAMAGAZEVideoTransformer_gaze
# from src.modeling.bddoia_classification_gaze_selfattn import DRAMAGAZEVideoTransformer_gaze
# from src.modeling.bddoia_classification_gaze_selfattn_onlyf import DRAMAGAZEVideoTransformer_gaze
from src.modeling.bddoia_classification_gaze_selfattn_onlys import DRAMAGAZEVideoTransformer_gaze
    ...
    def gen_rows():
        ...
        with torch.no_grad():
            for step, (img_keys, batch, meta_data) in tqdm(enumerate(test_dataloader)):
                ...
                for img_key, pred_action, pred_reason, label_action, label_reason in zip(img_keys, preds_action, preds_reason, labels_action, labels_reason):
                    res = []
