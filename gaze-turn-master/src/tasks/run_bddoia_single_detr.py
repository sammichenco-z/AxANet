            ...
            if (args.save_steps > 0 and global_step % args.save_steps == 0) or global_step == max_global_step:
                ...
                if args.evaluate_during_training:
                    ...
                    if is_main_process():
                        ...
                        if epoch%10 == 0 or epoch == 0 or epoch == 1:
...
def get_custom_args(base_config):
    ...
    parser.add_argument('--load_detr', type=str, default='None')
...
def main(args):
    ...
    if args.load_detr != 'None':
        cpu_device = torch.device('cpu')
        detr_pretrained_model = torch.load(args.load_detr, map_location=cpu_device)
