...
class BertSelfAttention(nn.Module):
    def __init__(self, config):
        ...
        self.bert_drop = nn.Dropout(config.attention_probs_dropout_prob)
    ...
    def forward(self, hidden_states, attention_mask, head_mask=None,
        ...
        attention_probs = self.bert_drop(attention_probs)
...
class BertForImageCaptioning(BertPreTrainedModel):
    ...
    def encode_forward(self, input_ids, img_feats, attention_mask,
            ...
            is_training=True, encoder_history_states=None, bbox=None):
