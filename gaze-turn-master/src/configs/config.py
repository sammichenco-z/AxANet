...
class SharedConfigs(object):
    ...
    def __init__(self, desc="shared config"):
        ...
        parser.add_argument("--pred_bbox", type=str_to_bool, nargs='?', const=True, default=False,
                            help="pred pred_bbox")
        parser.add_argument("--gaze_pred", type=str_to_bool, nargs='?', const=True, default=False,
        ...
        parser.add_argument("--bddoia", type=str_to_bool, nargs='?', const=True, default=False,
                            help="add head for bddoia")
        parser.add_argument("--visualize_attn", type=str_to_bool, nargs='?', const=True, default=False,
                            help="add head for visualize_attn")
        ...
        parser.add_argument("--model_size", type=str, default='base',
                           choices=['tiny', 'small', 'base', 'large', 'huge'], 
                            help="tiny_model=[2, 4, 128];small_model=[4, 8, 256];base_model=[6, 8, 256];large_model=[8, 8, 512];huge_model=[12, 16, 1024]")
        #======= mask token
